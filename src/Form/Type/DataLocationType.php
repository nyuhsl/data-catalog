...
class DataLocationType extends AbstractType {
  ...
  public function buildForm(FormBuilderInterface $builder, array $options) {
    $builder->add('data_location',TextareaType::class,array(
      'label'=>false,
      'required'=>true,
      'attr'=>array('placeholder'=>'* Data Location'))
      );
    $builder->add('location_content',TextareaType::class,array(
      'label'=>false,
      'required'=>false,
      'attr'=>array('placeholder'=>'Location Content'))
      );
    $builder->add('data_access_url',TextareaType::class,array(
      'label'=>false,
      'required'=>true,
      'attr'=>array('placeholder'=>'* Location URL'))
      );
    $builder->add('accession_number', TextareaType::class, array(
      'required' => false,
      'label'    => false,
